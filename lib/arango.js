...
var api_modules = ["cursor","collection","document","index","session"];
...
var ArangoDB = function(){
  ...
  if( typeof arguments[i] === "object" ) {
    options = extend(true,options,arguments[i++]);
  }
  ...
  for(var i in api_modules) 
    this[api_modules[i]] = require(__dirname+'/api/'+api_modules[i])(this);
