...
var ArangoDB = function(){
   ...
   * if present and returns the request.
   * TODO: make synchronous and normalize errors. 
   */  
  ...
  this.head = request_wrap(request.head);
  this.raw = request_wrap(request.raw);
