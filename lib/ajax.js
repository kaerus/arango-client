...
define(function (require) {
    ...
    var Xhr = BROWSER ? (function() {
        ...
        if(typeof window.XMLHttpRequest !== 'undefined' ) {
            ...
            for (var i = 0, l = ver.length; i < l; i++) {
                try { return window.ActiveXObject(ver[i]) } catch (e) {}
            } 
    ...
    function Ajax(options,callback) {
        (function() {
            /* use nodejs request */
            if(Xhr === 'nodejs') {
                var xhr = require(options.protocol||'http').request;
                Ajax = function(options,callback) {
                    delete options.protocol;
                    if(options.timeout) {
                        xhr.socket.setTimeout(options.timeout);
    ...
    Ajax.prototype.request = function(options,callback) {
        ...
        var isFile = options.protocol === 'file' && BROWSER,
