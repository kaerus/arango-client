        ...
        "get":params([{match:"boolean"},{id:"string"},{rev:"string"},{callback:"function"}],
            function(match,id,rev,callback) {
                if(match !== undefined) {
                    ...
                    else return db['raw']({method:'GET',headers:{"If-None-Match":rev||id}},path+id,callback);
                }
        ...
        "put":params([{match:"boolean"},{id:"string"},{rev:"string"},{data:"object"},{callback:"function"}],
            function(match,id,rev,data,callback) {
                if(match !== undefined) {
                    ...
                    else return db['raw']({method:'PUT',headers:{"If-None-Match":rev||id}},path+id,data,callback);
                }
        ...
        "patch":params([{match:"boolean"},{id:"string"},{rev:"string"},{data:"object"},{callback:"function"}],
            function(match,id,rev,data,callback) {
                if(match !== undefined) {
                    ...
                    else return db['raw']({method:'PATCH',headers:{"If-None-Match":rev||id}},path+id,data,callback);
                }
