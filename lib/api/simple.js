...
return function(db){
  ...
  return {
    "list": function() {
      ...
      return X.put(path+'all',applyOptions(data,options),callback);
    },
    "example": function() {
      var data = {collection: db.name}, i = 0, options, callback;
      ...
      return X.put(path+'by-example',applyOptions(data,options),callback);
    },
    "first": function() {
      var data = {collection: db.name}, i = 0, options, callback;
    ...
    "range": function() {
      ...
      return X.put(path+'range',applyOptions(data,options),callback);
    },
    "near": function() {
      var data = {collection: db.name}, i = 0, options, callback;
      ...
      return X.put(path+'near',applyOptions(data,options),callback);
    },
    "within": function() {
      var data = {collection: db.name}, i = 0, options, callback;
      ...
      return X.put(path+'within',applyOptions(data,options),callback);
    },
    "skip": function(val) {
        skip = val;
    },
